...
var (
	...
	configPath = fileutils.ApplicationDir(filepath.Join("ultimatedivision", "nftsigner"))
)
...
func cmdSetup(cmd *cobra.Command, args []string) (err error) {
	...
	configFile, err := os.Create(path.Join(setupDir, "/config_nft_signer.json"))
	if err != nil {
...
func readConfig() (config Config, err error) {
	configBytes, err := ioutil.ReadFile(path.Join(configPath, "/config_nft_signer.json"))
	if err != nil {
		return Config{}, err
	}
