...
func (db *database) CreateSchema(ctx context.Context) (err error) {
	createTableQuery :=
		...
		CREATE TABLE IF NOT EXISTS cards (
			...
			picture_type      BYTEA    REFERENCES picture_types(img)  NOT NULL,
			height            DECIMAL                                 NOT NULL,
			weight            DECIMAL                                 NOT NULL,
			skin_color        BYTEA    REFERENCES skin_colors(img)    NOT NULL,
			hair_style        BYTEA    REFERENCES hair_styles(img)    NOT NULL,
			hair_color        BYTEA    REFERENCES hair_colors(img)    NOT NULL,
