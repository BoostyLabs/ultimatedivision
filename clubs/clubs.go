...
type DB interface {
	...
	// GetCaptain returns id of captain.
	GetCaptain(ctx context.Context, squadID uuid.UUID) (uuid.UUID, error)
	...
	UpdateCaptain(ctx context.Context, capitan uuid.UUID, squadID uuid.UUID) error
